...
public interface BookOrderPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int BOOK_ORDER_FEATURE_COUNT = 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link bookOrder.Universe#getBookorder <em>Bookorder</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Bookorder</em>'.
	 * @see bookOrder.Universe#getBookorder()
	 * @see #getUniverse()
	 * @generated
	 */
	EReference getUniverse_Bookorder();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link bookOrder.BookOrder#getBook <em>Book</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Book</em>'.
	 * @see bookOrder.BookOrder#getBook()
	 * @see #getBookOrder()
	 * @generated
	 */
	EReference getBookOrder_Book();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference UNIVERSE__BOOKORDER = eINSTANCE.getUniverse_Bookorder();
		 ...
		 * @generated
		 */
		EReference BOOK_ORDER__BOOK = eINSTANCE.getBookOrder_Book();
