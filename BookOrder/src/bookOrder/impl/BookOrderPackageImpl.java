...
public class BookOrderPackageImpl extends EPackageImpl implements BookOrderPackage {
	...
	public static BookOrderPackage init() {
		if (isInited) return (BookOrderPackage)EPackage.Registry.INSTANCE.getEPackage(BookOrderPackage.eNS_URI);

		// Obtain or create and register package
		BookOrderPackageImpl theBookOrderPackage = (BookOrderPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BookOrderPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BookOrderPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getUniverse_Bookorder() {
	 ...
	 * @generated
	 */
	public EReference getBookOrder_Book() {
		return (EReference)bookOrderEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(universeEClass, UNIVERSE__BOOKORDER);

		bookOrderEClass = createEClass(BOOK_ORDER);
		createEAttribute(bookOrderEClass, BOOK_ORDER__INFO);
		createEReference(bookOrderEClass, BOOK_ORDER__BOOK);
	...
	public void initializePackageContents() {
		...
		initEReference(getUniverse_Bookorder(), this.getBookOrder(), null, "bookorder", null, 0, -1, Universe.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bookOrderEClass, BookOrder.class, "BookOrder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBookOrder_Info(), ecorePackage.getEString(), "info", null, 0, 1, BookOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBookOrder_Book(), this.getBook(), null, "book", null, 0, -1, BookOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
