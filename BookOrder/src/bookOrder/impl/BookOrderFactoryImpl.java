...
public class BookOrderFactoryImpl extends EFactoryImpl implements BookOrderFactory {
	...
	public static BookOrderFactory init() {
		try {
			BookOrderFactory theBookOrderFactory = (BookOrderFactory)EPackage.Registry.INSTANCE.getEFactory(BookOrderPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case BookOrderPackage.UNIVERSE: return createUniverse();
			case BookOrderPackage.BOOK_ORDER: return createBookOrder();
			case BookOrderPackage.BOOK: return createBook();
			default:
