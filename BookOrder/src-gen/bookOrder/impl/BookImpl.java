 ...
 * </p>
 * <ul>
 *   <li>{@link bookOrder.impl.BookImpl#getBookorder <em>Bookorder</em>}</li>
...
public class BookImpl extends MinimalEObjectImpl.Container implements Book {
	...
	public EList<BookOrder> getBookorder() {
		if (bookorder == null) {
			bookorder = new EObjectContainmentEList<BookOrder>(BookOrder.class, this, BookOrderPackage.BOOK__BOOKORDER);
		}
		return bookorder;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BookOrderPackage.BOOK__BOOKORDER:
